...
Protocol:
  For each isolation value (True, False):
    Repeat N=30 times:
      ...
      4. Collect DB row count after seed, before regression, after regression.
      5. Delete the Preview.
      6. Write one row per suite to test_outcomes CSV.
...
def run_once(run_id: str, isolation: bool, cfg: dict) -> list[dict]:
    ...
    try:
        ...
        # Collect step timings as run_metrics rows
