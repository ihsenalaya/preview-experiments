\begin{table}[t]
\centering
\caption{Contribution of the 'isolation_probe' + 'baseline_count' categories to total failure load. Under iso=False these two categories typically account for >95% of all assertion failures, supporting that the operator's checkpoint mechanism specifically eliminates inter-test pollution.}
\label{tab:T1_assertion_isolation_sensitive}
