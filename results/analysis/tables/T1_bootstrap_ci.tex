\begin{table}[t]
\centering
\caption{Bootstrap 95% confidence intervals (10,000 resamples, seed=20260517) on median estimates for RQ1 (failure rate) and RQ3 (per-run total cycle time, seconds).}
\label{tab:T1_bootstrap_ci}
