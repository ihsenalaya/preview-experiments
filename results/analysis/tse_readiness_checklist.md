...
- [x] **A1.** `results/frozen/` existe, contient ≥ 1 CSV par RQ × sujet
- [x] **A2.** `results/frozen/MANIFEST.json` avec SHA-256 par fichier
- [x] **A3.** `results/frozen/excluded_datasets.csv` avec raison d'exclusion
...
- [ ] **G5.** Tous les chiffres dans le LaTeX référencent un CSV (commentaire `% from results/frozen/.../<csv>:<line>` ou via macros)
